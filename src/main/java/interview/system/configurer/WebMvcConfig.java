        ...
        exceptionResolvers.add(new HandlerExceptionResolver() {
            public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception e) {
                ...
                if (e instanceof ServiceException) {//业务失败的异常，如“账号或密码错误”
                    ...
                    result.setCode(ResultCode.valueOf(response.getStatus()+"")).setMessage("" + response.getStatus());
                } else if (e instanceof SystemException) {
                	 result.setCode(ResultCode.INTERNAL_SERVER_ERROR).setMessage(request.getRequestURL()+""+ response.getStatus()+ ": " + e.getMessage()).setData("");
